...
Calendly._util.domReady = function(t) {
    var e = !1
      ...
      , o = function() {
        e || !document.addEventListener && "load" !== event.type && "complete" !== document.readyState || (e = !0,
        n(),
        t())
    };
...
function() {
    Calendly._util.snakeCaseKeys = function(t) {
        ...
        o = {};
        for (n in t)
            e = n.split(/(?=[A-Z])/).join("_").toLowerCase(),
            o[e] = t[n];
        return o
    }
    ,
...
function(t, e) {
    ...
    "function" == typeof define && define.amd ? define(["exports"], e) : "undefined" != typeof exports && (n.exports = exports),
    e(n.exports),
      ...
      , p = function(t) {
        setTimeout(function() {
            if (void 0 === u) {
                ...
                e && n > 0 && (u = document.body.style.paddingRight,
    ...
    t.enableBodyScroll = function(t) {
        if (i) {
            ...
            1 === r.length && r[0].targetElement === t ? (h(),
...
function() {
    ...
    Calendly.destroyBadgeWidget = function() {
        return Calendly.badgeWidget ? (Calendly.badgeWidget.destroy(),
    ...
    Calendly.initInlineWidget = function(t) {
        return t.url ? (t.parentElement || (t.parentElement = o()),
        Calendly._util.domReady(function() {
            return t.embedType = "Inline",
            new Calendly.Iframe(t)
        })) : void 0
    }
    ,
    ...
    e = function() {
        ...
        o = e.length; o > n; n++)
            t = e[n],
            i(t) ? r.push(void 0) : (t.setAttribute("data-processed", !0),
            r.push(new Calendly.Iframe({
                parentElement: t,
                inlineStyles: !0,
                embedType: "Inline"
            })));
...
function() {
    Calendly.Iframe = function() {
        ...
        t.prototype.getParams = function() {
            ...
            e = Calendly._util.assign(e, this.getUtmParamsFromHost(), this.getParamsFromUrl(), this.getParamsFromOptions()),
            n = [];
            for (t in e)
                o = e[t],
        ...
        t.prototype.getUtmParamsFromHost = function() {
            var t, e;
            return t = ["utm_campaign", "utm_source", "utm_medium", "utm_content", "utm_term"],
        ...
        t.prototype.getUtmParams = function() {
            var t;
            return this.options.utm ? (t = ["utmCampaign", "utmSource", "utmMedium", "utmContent", "utmTerm"],
            Calendly._util.snakeCaseKeys(Calendly._util.pick(this.options.utm, t))) : null
        }
        ,
